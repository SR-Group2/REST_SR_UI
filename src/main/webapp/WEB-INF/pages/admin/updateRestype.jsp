				...
				<div class="panel-body">
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="restype_name" value="{{restype_name}}" ng-model="restype_name" placeholder="Ex. Khmer Food, BBQ,..." required>
						</div>
						<div class="form-group">
							<label for="restype_name_kh">Restaurant Type EN</label>
							<input type="text" class="form-control" name="restype_name_kh" value="{{restype_name_kh}}" ng-model="restype_name_kh" placeholder="Ex...." required>
						</div>
						<div class="form-group">
							<label for="description">Description</label>
							<textarea class="form-control" rows="10" cols="20" value="{{description}}" ng-model="description" id="description"></textarea>
						</div>	
					</div> 
					<div class="col-md-5">
						<%-- <div class="form-group">
						...
						<div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden">
							<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
								<img src="http://localhost:9999{{restype_picture}}"/>
							</div> 
							...
							<button type="button" class="btn btn-primary btn-block" ng-click="updateRestype()">
